        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(257)", maxLength: 257, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserIdFK = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Customers", x => x.CustomerId);
                    table.ForeignKey(
                        name: "FK_Customers_Users_UserIdFK",
                        column: x => x.UserIdFK,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverIdFK = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    BookingDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PickUpDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PickUpCoordinate = table.Column<double>(type: "float", nullable: false),
                    DropOffCoordinate = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Drivers_DriverIdFK",
                        column: x => x.DriverIdFK,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_DriverIdFK",
                table: "Bookings",
                column: "DriverIdFK");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_UserIdFK",
                table: "Customers",
                column: "UserIdFK",
                unique: true);
