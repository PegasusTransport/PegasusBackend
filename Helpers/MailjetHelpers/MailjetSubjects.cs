namespace PegasusBackend.Helpers.MailjetHelpers
{
    ...
    {
        public const string Welcome = "🚖 Welcome to Pegasus Transport 🚖";
        public const string ForgotPassword = "🔑 Reset your password";
        public const string TwoFA = "Your security code for logging in to Pegasus Taxi 🔐";
