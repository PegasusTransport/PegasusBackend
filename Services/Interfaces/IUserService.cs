...
namespace PegasusBackend.Services.Interfaces
{
    public interface IUserService
    {
        ...
        Task<ServiceResponse<RegistrationResponseDto>> RegisterUserAsync(RegistrationRequestDto request, string confirmationLink);
        Task<ServiceResponse<string>> ConfirmUserEmailAsync(string email, string token);
